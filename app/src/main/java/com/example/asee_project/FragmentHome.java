...
public class FragmentHome extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button buscadorHotel = (Button) v.findViewById(R.id.home_buscador_hoteles);
        buscadorHotel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                getActivity().getSupportFragmentManager().beginTransaction()
                        ...
                        .addToBackStack(null)
                        .commit();
                //Intent intent = new Intent(getActivity().getApplication(),BuscadorHotelesActivity.class);
