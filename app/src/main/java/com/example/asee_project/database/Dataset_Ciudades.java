...
public class Dataset_Ciudades {
    ...
    public List<Ciudad> getDataSet() {
        List<Ciudad> lista = new ArrayList<Ciudad>() {{
            ...
            add(new Ciudad("ALC","Alicante","1",R.drawable.alicante));
            add(new Ciudad("LEI","Almeria","1",R.drawable.almeria));
            add(new Ciudad("OVD","Asturias","0",R.drawable.asturias));
            add(new Ciudad("BCN","Barcelona","1",R.drawable.barcelona));
            add(new Ciudad("BIO","Bilbao","1",R.drawable.bilbao));
            add(new Ciudad("FUE","Fuerteventura","0",R.drawable.fuerteventura));
            add(new Ciudad("GRO","Girona","0",R.drawable.girona));
            add(new Ciudad("LPA","Gran Canaria","1",R.drawable.grancanaria));
            add(new Ciudad("GRX","Granada","0",R.drawable.granada));
            add(new Ciudad("IBZ","Ibiza","1",R.drawable.ibiza));
            add(new Ciudad("ACE","Lanzarote","1",R.drawable.lanzarote));
            ...
            add(new Ciudad("SVQ","Sevilla","1",R.drawable.sevilla));
