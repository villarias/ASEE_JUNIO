...
public class AdaptadorMisHoteles extends RecyclerView.Adapter<AdaptadorMisHoteles.ViewHolder> {
    ...
    public interface OnHotelClickListener {
        void onItemHotelClick(Hotel datum);     //Type of the element to be returned
    }
    public interface OnEditarClickListener {
        void onEditaItemClick(Hotel datum);     //Type of the element to be returned
    }
    public interface OnBorrarlClickListener {
        void onBorrarItemClick(Hotel datum);     //Type of the element to be returned
    }
    ...
    public AdaptadorMisHoteles(List<Hotel>data, OnHotelClickListener listener, OnEditarClickListener listener_edit, OnBorrarlClickListener listener_borrar) {
    ...
    public void swap(List<Hotel> data){
        this.data = data;
